  ...
  return (
    <div className="space-y-1">
      ...
      <div className="flex items-center justify-between px-3 py-1.5 group">
        ...
        >
          <span className="text-icloud-text-secondary hover:text-icloud-text-primary dark:hover:text-white transition-colors">
            {isExpanded ? (
          ...
          <span className="text-[10px] font-bold text-icloud-text-secondary uppercase tracking-wider">
            {title}
          </span>
        </button>
        ...
        {actionButton && (
          <button
            ...
            className="p-1 text-icloud-accent hover:bg-black/[0.05] dark:hover:bg-white/[0.10] rounded transition-colors opacity-100 [@media(hover:hover)]:opacity-0 [@media(hover:hover)]:group-hover:opacity-100 min-w-[32px] min-h-[32px] flex items-center justify-center"
