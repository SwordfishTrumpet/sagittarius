...
export function ImageApprovalBanner({
  ...
  return (
    <div className="mx-8 mt-8 mb-6 p-4 rounded-xl bg-white/60 bg-icloud-bg-primary/60 backdrop-blur-md border border-icloud-border shadow-sm animate-in fade-in slide-in-from-top-2 duration-300 dark:bg-icloud-bg-layer2/60">
